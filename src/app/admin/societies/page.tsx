...
export default function AdminSocietiesPage() {
  ...
  return (
    <section className="space-y-6">
      <div className="flex items-start justify-between gap-4"><div><h1 className="text-3xl font-bold text-slate-900">Manage Societies</h1><p className="mt-2 text-slate-600">View, create, edit, and delete societies.</p></div><button type="button" onClick={openCreateModal} className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-900 text-2xl font-semibold text-white shadow-sm transition hover:bg-slate-700">+</button></div>
